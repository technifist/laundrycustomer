...
const PaymentReducer = (state = { isLoding: false, error: undefined, data:undefined, payments:undefined, stripe:undefined, message:undefined, status:undefined }, action) => {
    switch (action.type) {
