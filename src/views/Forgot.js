...
import { api_url, height_60, height_20, forgot, forgot_password,font_title, font_description } from '../config/Constants';
        ...
        <View style={styles.container}>
          ...
          <View style={styles.block_one} >
            ...
            <View style={styles.description_content} >
              <Text style={styles.description} >{strings.enter_your_email_below_to_receive_the_instructions_to_reset_your_password}</Text>
            </View>
          </View>
