...
import { api_url, address_list, address_delete, img_url, height_30, no_data, font_title, font_description  } from '../config/Constants';
      ...
      <Container style={{ backgroundColor: colors.theme_bg_two }} > 
        <Header androidStatusBarColor={colors.theme_bg} style={styles.header} >
          ...
          <Body style={styles.header_body} >
            <Title style={{ alignSelf:'center', color:'#202028', fontSize:16, fontFamily:font_title }} >{strings.manage_addresses}</Title>
          </Body>
          <Right />
        </Header>
        <ScrollView>
