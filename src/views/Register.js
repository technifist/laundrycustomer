...
import { api_url, register, height_40, login_image,font_title, font_description } from '../config/Constants';
  ...
  register = async () => {
    ...
    if(this.state.validation){
        ...
        await axios({
          ...
          data:{ customer_name: this.state.customer_name, phone_number: this.state.phone_number, email: this.state.email, password: this.state.password, fcm_token:this.state.fcm_token }
        })
        .then(async response => {
      ...
      <ScrollView keyboardShouldPersistTaps='always'>
        <View style={styles.container}>
              ...
              <CardItem bordered style={{ borderRadius: 20}}>
                <View style={styles.body_section} >
                  ...
                  <View style={styles.footer_section} >
                    <View style={{height:40, width:'100%', marginTop:10, marginBottom:10}} >
                      <Button
          ...
          <View style={styles.login_container} >
            <Text style={{ color:colors.theme_fg, fontSize:16,fontFamily:font_description }} onPress={this.handleBackButtonClick} >{strings.already_i_have_an_account}</Text>
          </View>
        </View>
      </ScrollView>
    )
