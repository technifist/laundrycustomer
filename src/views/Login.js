...
import { api_url, login, height_40, height_30, height_15, login_image,font_title, font_description } from '../config/Constants';
  ...
  login = async () => {
    ...
    if(this.state.validation){
        ...
        await axios({
          method: 'post', 
          url: api_url + login,
          data:{ email: this.state.email, password: this.state.password, fcm_token:this.state.fcm_token }
        })
        .then(async response => {
      ...
      <ScrollView keyboardShouldPersistTaps='always'>
        <View style={styles.container}>
              ...
              <CardItem bordered style={{ borderRadius: 20}}>
                <View style={styles.body_section} >
                  ...
                  <View style={styles.forgot_password_container} >
                    <Text onPress={this.forgot} style={{ color:colors.theme_fg_four,fontFamily:font_description }} >{strings.forgot_your_password}</Text>
                  </View>
                </View>
              </CardItem>
            </Card>
          ...
          <View style={styles.signup_container} >
            <Text style={{ color:colors.theme_fg, fontSize:16,fontFamily:font_description }} onPress={this.register}  >{strings.signup_for_a_new_account}</Text>
          </View>
        </View>
      </ScrollView>
    )
